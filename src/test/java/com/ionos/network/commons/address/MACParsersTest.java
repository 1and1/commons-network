...
public class MACParsersTest {
    ...
    public void defaultParse() {
        final MAC mac = MACParsers.DEFAULT.parse("6C:88:14:6F:D8:91");
    ...
    public void colonParse() {
        final MAC mac1 = MACParsers.COLON_SEPARATED_HEX_FORMAT.parse("11:22:33:44:FF:bb");
    ...
    public void colonParseWithElementTooLong() {
        Assertions.assertThrows(IllegalArgumentException.class, () ->
            MACParsers.COLON_SEPARATED_HEX_FORMAT.parse("111:22:33:44:FF:bb"));
    }

    @Test
    public void colonParseWithElementTooManyElements() {
        Assertions.assertThrows(IllegalArgumentException.class, () ->
                MACParsers.COLON_SEPARATED_HEX_FORMAT.parse("00:11:22:33:44:FF:bb"));
    }

    @Test
    public void ciscoParse() {
        final MAC mac1 = MACParsers.CISCO_CUSTOM_FORMAT.parse("6c88.146f.d891");
        final byte[] array1 = new byte[]{108, -120, 20, 111, -40, -111};

        assertArrayEquals(array1, mac1.getBytes());

        final MAC mac2 = MACParsers.CISCO_CUSTOM_FORMAT.parse("0000.146f.d891");
    ...
    public void ciscoParseWithElementTooLong() {
        Assertions.assertThrows(IllegalArgumentException.class, () ->
                MACParsers.CISCO_CUSTOM_FORMAT.parse("0000.11111.2222"));
    }
    @Test
    public void ciscoParseWithElementTooManyElements() {
        Assertions.assertThrows(IllegalArgumentException.class, () ->
                MACParsers.CISCO_CUSTOM_FORMAT.parse("0000.1111.2222.33333"));
    }
}
